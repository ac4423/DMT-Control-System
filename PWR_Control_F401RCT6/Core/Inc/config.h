...
#define FLOW_SCHEDULE_LEN        128   // e.g. 128 * 10ms = 1.28s future

// Minimum number of ticks that must always be buffered ahead
...
/* --- Calibration parameters for LOOK-UP TABLE --- */
